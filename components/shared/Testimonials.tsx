  ...
  return (
    <div className="mt-40">
      ...
      <div className="bg-[var(--colorDark)] py-20 rounded-4xl mt-20">
        <div className="max-w-2xl border-2 border-[var(--colorGreen)] m-auto p-10 text-base-content">
          <article>&quot;We have been working with Positivus for the past year and have seen a significant increase in website traffic and leads as a result of their efforts. The team is professional, responsive, and truly cares about the success of our business. We highly recommend Positivus to any company looking to grow their online presence.&quot;</article>
        </div>
      </div>
    </div>
  );
